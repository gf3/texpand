...
| increment | 15 | The _increment_ can be thought of as the amount of buffer space at the bottom of the textarea. |
| onExpand | _function_ | Technically not an option, this is a callback that gets executed after the textarea expands/shrinks. It receives the _keyup_ event as its only parameter. |
...
Contributions by Michael Harris - "harrisdev.net":http://harrisdev.net/
